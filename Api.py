...
# Salary range and SIP profile calculation (from provided logic)
...
min_sip_amount = 10000  # Minimum SIP amount
...
# API route to get SIP data
@app.route('/sip-data', methods=['GET'])
def get_sip_data():
    sip_data = calculate_sip_data()
    return jsonify(sip_data)
